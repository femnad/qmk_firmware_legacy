...
[MDIA] = LAYOUT_moonlander(
        ...
        KC_WH_U, _______, KC_WH_L, KC_MS_U, KC_WH_R, _______, _______, _______, _______, KC_ACL2, KC_ACL1, KC_ACL0, _______, _______,
        KC_WH_D, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______, _______, KC_BTN1, KC_BTN2, KC_BTN2, _______, _______,
