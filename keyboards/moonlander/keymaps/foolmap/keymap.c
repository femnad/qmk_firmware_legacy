 ...
 * +-------+------+------+--------+-------+-------+-------+-------+-------+-------+------+------+-------+---------+
 * | MUTE  | QUOT | COMM |  DOT   |   P   |   Y   |  TAB  |  ENT  |   F   |   G   |  C   |  R   |   L   |  VOLU   |
 * +-------+------+------+--------+-------+-------+-------+-------+-------+-------+------+------+-------+---------+
 * | MPLY  |  A   |  O   |   E    |   U   |   I   | ^LSFT | ^RSFT |   D   |   H   |  T   |  N   |   S   |  VOLD   |
 * +-------+------+------+--------+-------+-------+-------+-------+-------+-------+------+------+-------+---------+
 * | CLEAR | SCLN |  Q   |   J    |   K   |   X   |               |   B   |   M   |  W   |  V   |   Z   |  CLEAR  |
 * +-------+------+------+--------+-------+-------+               +-------+-------+------+------+-------+---------+
 * | ^LGUI | HOME | PGUP | PGDOWN |  END  | @SYMB |               | @SYMB | LEFT  | DOWN |  UP  | RIGHT |  ^RGUI  |
 * +-------+------+------+--------+-------+-------+               +-------+-------+------+------+-------+---------+
 ...
 * +-------+------+------+--------+-------+-------+-------+-------+-------+-------+------+------+-------+---------+
 * | MPRV  | EXLM |  AT  |  HASH  |  DLR  | PERC  |       |       | CIRC  | AMPR  | ASTR | F11  |  F12  |  WBAK   |
 * +-------+------+------+--------+-------+-------+-------+-------+-------+-------+------+------+-------+---------+
 * | MNXT  | LCBR | RCBR |  LPRN  | RPRN  |  EQL  |       |       | SLSH  | MINS  | UNDS | LBRC | RBRC  |  WFWD   |
 * +-------+------+------+--------+-------+-------+-------+-------+-------+-------+------+------+-------+---------+
 * |       |      |      |  TILD  | PIPE  |  GRV  |               | BSLS  | PLUS  | DEL  | INS  | BSLS  |         |
 * +-------+------+------+--------+-------+-------+               +-------+-------+------+------+-------+---------+
 * |       |      |      |        |       |       |               |       |       |      |      |       |         |
 * +-------+------+------+--------+-------+-------+               +-------+-------+------+------+-------+---------+
 *                       |        |       |       |               |       |       |      |
 ...
 * |       |      |      |        |       |       |       |       |       |       |      |      |       |         |
 * +-------+------+------+--------+-------+-------+-------+-------+-------+-------+------+------+-------+---------+
 * |  WHU  |      | WHL  |  MSU   |  WHR  |       |       |       |       | ACL2  | ACL1 | ACL0 |       |  C-TAB  |
 * +-------+------+------+--------+-------+-------+-------+-------+-------+-------+------+------+-------+---------+
 * |  WHD  |      | MSL  |  MSD   |  MSR  |       |       |       |       | BTN1  | BTN2 | BTN2 |       | C-S-TAB |
 * +-------+------+------+--------+-------+-------+-------+-------+-------+-------+------+------+-------+---------+
 * |       |      |      |        |       | RESET |               | RESET |       |      |      |       |         |
 * +-------+------+------+--------+-------+-------+               +-------+-------+------+------+-------+---------+
 * |       |      |      |        |       |       |               |       |       |      |      |       |         |
...
[BASE] = LAYOUT_moonlander(
        ...
        KC_MPLY,       KC_A,          KC_O,          KC_E,          KC_U,          KC_I,      OSM(MOD_LSFT), OSM(MOD_RSFT), KC_D,    KC_H,  KC_T,     KC_N,          KC_S, KC_VOLD,
        CLEAR,         KC_SCLN,       KC_Q,          KC_J,          KC_K,          KC_X,      KC_B,          KC_M,          KC_W,    KC_V,  KC_Z,     CLEAR,
        OSM(MOD_LGUI), KC_HOME,       KC_PGUP,       KC_PGDOWN,     KC_END,        OSL(SYMB), OSL(SYMB),     KC_LEFT,       KC_DOWN, KC_UP, KC_RIGHT, OSM(MOD_RGUI),
...
[MDIA] = LAYOUT_moonlander(
        ...
        KC_WH_U, _______, KC_WH_L, KC_MS_U, KC_WH_R, _______, _______, _______, _______, KC_ACL2, KC_ACL1, KC_ACL0, _______, RCTL(KC_TAB),
        KC_WH_D, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______, _______, KC_BTN1, KC_BTN2, KC_BTN2, _______, RCTL(LSFT(KC_TAB)),
