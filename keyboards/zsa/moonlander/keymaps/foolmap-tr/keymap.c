 ...
 * +------+------+------+------+------+------+------+------+------+------+------+------+------+------+
 * | VOLU |  '   |  ,   |  .   |  P   |  Y   | TAB  | ENT  |  F   |  G   |  C   |  R   |  L   | VOLU |
 * +------+------+------+------+------+------+------+------+------+------+------+------+------+------+
 * |@TRLC |  A   |  O   |  E   |  U   |  I   |^LSFT |^RSFT |  D   |  H   |  T   |  N   |  S   |@TRUC |
 * +------+------+------+------+------+------+------+------+------+------+------+------+------+------+
...
[BASE] = LAYOUT_moonlander(
        ...
        KC_VOLU,       KC_QUOT,       KC_COMM,       KC_DOT,        KC_P,          KC_Y,      KC_TAB,        KC_ENT,        KC_F,    KC_G,  KC_C,     KC_R,          KC_L, KC_VOLU,
        OSL(TRLC),     KC_A,          KC_O,          KC_E,          KC_U,          KC_I,      OSM(MOD_LSFT), OSM(MOD_RSFT), KC_D,    KC_H,  KC_T,     KC_N,          KC_S, OSL(TRUC),
...
[TRLC] = LAYOUT_moonlander(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, G_BRV_L, C_CDL_L, _______, _______, _______,
        _______, _______, O_DIA_L, _______, U_DIA_L, I_DLS_L, _______, _______, _______, _______, _______, _______, S_CDL_L, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______
),
...
[TRUC] = LAYOUT_moonlander(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, G_BRV_U, C_CDL_U, _______, _______, _______,
        _______, _______, O_DIA_U, _______, U_DIA_U, I_DAB_U, _______, _______, _______, _______, _______, _______, S_CDL_U, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______
),
