 ...
 * |      |      | PGUP |      |      | MPRV | MNXT |      |      |  UP  |      |      |
 * +------+------+------+------+------+------+------+------+------+------+------+------+
 * |      | HOME | PGDN | END  | INS  |      |      | DEL  | LEFT | DOWN | RGHT |      |
 * +------+------+------+------+------+------+------+------+------+------+------+------+
 * |      |      |      |      | BOOT |      |      | BOOT |      |      |      |      |
 * +------+------+------+------+------+------+------+------+------+------+------+------+
 * |      |      |      |      |      |      |      |      |      |      |      |      |
...
[MDIA] = LAYOUT_preonic_grid(
        _______, _______, _______, _______, _______, KC_MUTE, KC_MPLY, _______, _______, _______, KC_F11,  KC_F12,
        _______, _______, KC_PGUP, _______, _______, KC_MPRV, KC_MNXT, _______, _______, KC_UP,   _______, _______,
